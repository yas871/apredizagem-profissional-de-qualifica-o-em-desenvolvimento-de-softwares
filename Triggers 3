...
UPDATE tb_compra
-- Aumentar o calor do campo compra_qtd_cod em 1
SET compra_qtd_cod = compra_qtd_cod + 1
-- Especificar a condição para atualizar apenas a linha correspondente ao código de compra inserida
WHERE compra_cod = NEW.compra_cod;
-- Terminar o bloco de código do gatilho
END$$
-- Restaurar o delimitador de comandos para o padrãoptimize
DELIMITER ;
