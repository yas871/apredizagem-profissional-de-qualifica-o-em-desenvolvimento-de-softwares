...
create table `bd_caso_estudos_de_vendas`.`tb_cli`(
   ...
   `cli_end_cap`  varchar(9) null
);
create table `bd_caso_estudos_de_vendas`.`tb_prod_comp`(
 `prod_cod` int not null,
 `compra_cod` int not null
);
create table `bd_caso_estudos_de_vendas`.`tb_prod`(
   `prod_cod` int not null primary key,
   `prod_forn_cod` int not null,
   `prod_desc` varchar(60) null,
    `prod_vlr` decimal null
);
create table `bd_caso_estudos_de_vendas`.`tb_cli_tel`(
